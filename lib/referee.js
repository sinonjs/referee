((typeof define === "function" && define.amd && function (m) {
    ...
    function internalAssertion(type, name, func, messageValues) {
    ...
    function defineAssertion(type, name, func, minArgs, messageValues) {
        var internal = internalAssertion(type, name, func, messageValues);
        referee[type][name] = function () {
            ...
            var failureMessage;
            when(internal.apply(this, arguments)).
                then(function(args) {
                    failed = false;
        ...
        referee[type][name].internal = internal;
    }
