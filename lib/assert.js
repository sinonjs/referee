...
(function () {
    ...
    function fail(assertion, msg) {
        msg = buster.assert[assertion][msg];
        ...
        buster.assert.fail("[assert." + assertion + "] " + msg);
    }
    ...
    buster.assert.msgFail = "[assert] Expected ${1} to be thruthy";
    ...
    buster.assert.typeOf.msgFail = "${0}Expected typeof ${2} (${3}) to be ${1}";
    ...
    buster.assert.notTypeOf.msgFail = "${0}Expected typeof ${2} not to be ${1}";
    ...
    buster.assert.isObject.msgFail = "${0}Expected typeof ${1} (${2}) to be object and not null";
    ...
    buster.assert.isNumber.msgFail = "${0}Expected typeof ${1} (${2}) to be number";
    ...
    buster.assert.isNotNaN.msgFail = "${0}Expected not to be NaN";
    ...
    buster.assert.isUndefined.msgFail = "${0}Expected typeof ${1} (${2}) to be undefined";
    ...
    buster.assert.isNotUndefined.msgFail = "${0}Expected not to be undefined";
    ...
    buster.assert.isNotNull = function (/*message, actual*/) {
        ...
        if (args[1] === null) {
            fail("isNotNull", "msgFail", args[0], args[1]);
        }
    };
    ...
    buster.assert.match.msgFail = "${0}Expected ${2} to match ${1}";
    ...
    buster.assert.noMatch.msgFail = "${0}Expected ${2} not to match ${1}";
    ...
    buster.assert.className = function (/*message, classNames, object*/) {
    ...
    buster.assert.notClassName = function (/*message, classNames, object*/) {
