...
(function () {
    ...
    ba.add("equals", function (actual, expected) {
    ...
    ba.add("isUndefined", function (actual) {
        return typeof actual == "undefined";
    }, {
        assertFail: "Expected ${1} (${2}) to be undefined",
        refuteFail: "Expected not to be undefined",
