...
(function () {
    ...
    function defineAssertion(type, name, func, assertionArgs) {
        assertionArgs = assertionArgs || func.length;

        ba[type][name] = function () {
            var fullName = type + "." + name;
            message = prepareAssertion(fullName, arguments, assertionArgs);
    ...
    ba.add = function (name, func, options) {
        defineAssertion("assert", name, func);
        defineAssertion("refute", name, function () {
