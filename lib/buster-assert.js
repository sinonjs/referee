...
(function () {
    ...
    assert.inDelta = function (actual, expected, delta, message) {
        ...
        if (Math.abs(actual - expected) > delta) {
            fail("inDelta", "msgFail", message, actual, expected, delta);
        }

        assert.pass("inDelta", message, actual, expected, delta);
    };
    ...
    assert.notInDelta = function (actual, expected, delta, message) {
        ...
        if (Math.abs(actual - expected) <= delta) {
            fail("notInDelta", "msgFail", message, actual, expected, delta);
        }

        assert.pass("notInDelta", message, actual, expected, delta);
    };
